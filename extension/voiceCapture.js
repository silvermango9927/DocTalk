    ...
    try {
      ...
      try {
        ...
        if (micError.name === 'NotAllowedError' || micError.name === 'PermissionDeniedError') {
          throw new Error('Microphone access was denied. Please click the camera icon in your browser\'s address bar to allow access, then try again.');
      ...
      if (this.audioContext.sampleRate !== this.sampleRate) {
        console.warn(`Requested ${this.sampleRate}Hz but got ${this.audioContext.sampleRate}Hz`);
      }
